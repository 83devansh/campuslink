...
console.log("Accepting task with user:", currentUser);
...
async function sendChatMessage() {
  ...
  try {
    ...
    const res = await fetch("https://campuslink-backend-2.onrender.com/search", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
